  ...
  return (
    <div className="flex min-h-svh flex-col bg-[#F4F8FA]">
      <header className="flex items-center gap-3 px-4 py-4 safe-area-top sticky top-0 z-20 bg-[#F4F8FA]">
        ...
        <h1 className="text-xl font-bold text-slate-900 leading-none">Edit le profil</h1>
      </header>
      <main className="px-4 py-6 flex-1 flex flex-col">
        <div className="bg-white rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100/50 space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-slate-400 ml-1">The phone number cannot be changed.</p>
          </div>
        </div>
        <div className="mt-auto pt-6">
          <button onClick={() => { alert('Profile mis à jour ! (Simulation)'); router.back() }} className="w-full bg-[#0066CC] text-white py-4 rounded-2xl font-bold shadow-[0_8px_20px_rgba(0,102,204,0.3)] hover:scale-[1.02] active:scale-95 transition-all">
