...
CREATE TABLE IF NOT EXISTS drivers (
  ...
  service_area ENUM('urbain', 'interurbain', 'les_deux') DEFAULT 'urbain',
  vehicle_type ENUM('berline', '7_places', 'suv', 'van') DEFAULT 'berline',
...
CREATE TABLE IF NOT EXISTS rides (
  ...
  base_fare DECIMAL(10, 2) DEFAULT 1000.00,
  distance_fare DECIMAL(10, 2),
  time_fare DECIMAL(10, 2),
  total_fare DECIMAL(10, 2),
  tarif_estime DECIMAL(10, 2),
  inclut_peage BOOLEAN DEFAULT FALSE,
  region_depart_id INT NULL,
  region_arrivee_id INT NULL,
  ...
  cancelled_by ENUM('client', 'driver', 'system') NULL,
